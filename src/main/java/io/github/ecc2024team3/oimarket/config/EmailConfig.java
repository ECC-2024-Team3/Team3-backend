...
public class EmailConfig {
    ...
    @Value("${spring.mail.properties.mail.smtp.connection timeout:5000}") // 기본값 5000ms
    ...
    private Properties getMailProperties() {
        ...
        properties.put("mail.smtp.connection timeout", String.valueOf(connectionTimeout)); //  int → String 변환
        properties.put("mail.smtp.timeout", String.valueOf(timeout)); //  int → String 변환
        properties.put("mail.smtp.write timeout", String.valueOf(writeTimeout)); //  int → String 변환
